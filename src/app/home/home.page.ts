...
export class HomePage {
  ...
  constructor(public bluetoothle: BluetoothLE, public plt: Platform, public alertController: AlertController) {
  ...
  write() {
    if (this.device) {
      var bytes = this.bluetoothle.stringToBytes(this.writeValue);
